        ...
        <div className="row">
          <div className="col-4">
            <div className="price">
              ...
              <h1 className="price__heading">Pizza Fajita</h1>
          ...
          <div className="col-4">
            <div className="price">
              ...
              <h1 className="price__heading">Pizza Chicken</h1>
              <p className="price__text">
                Nullam nibh sem, imperdiet ultrices commodo a, vulputate vel
                ligula. Duis venenatis at eros sed egestas. Mauris rutrum quam
                risus, vel hendrerit dui tempor in.
          ...
          <div className="col-4">
            <div className="price">
              ...
              <h1 className="price__heading">Pizza Mashroom</h1>
              <p className="price__text">
                Nullam nibh sem, imperdiet ultrices commodo a, vulputate vel
                ligula. Duis venenatis at eros sed egestas. Mauris rutrum quam
                risus, vel hendrerit dui tempor in.
          ...
          <div className="col-4">
            <div className="price">
              ...
              <h1 className="price__heading">Pizza Kabab</h1>
              <p className="price__text">
                Nullam nibh sem, imperdiet ultrices commodo a, vulputate vel
                ligula. Duis venenatis at eros sed egestas. Mauris rutrum quam
                risus, vel hendrerit dui tempor in.
          ...
          <div className="col-4">
            <div className="price">
              ...
              <h1 className="price__heading">Pizza Jalpanito</h1>
              <p className="price__text">
                Nullam nibh sem, imperdiet ultrices commodo a, vulputate vel
                ligula. Duis venenatis at eros sed egestas. Mauris rutrum quam
                risus, vel hendrerit dui tempor in.
